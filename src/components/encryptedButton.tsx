...
const EncryptButton: React.FC = () => {
    ...
    return (
        <motion.button
            ...
            className="group relative overflow-hidden rounded-lg border-[1px] border-neutral-500 bg-card-dark px-4 py-2 font-mono font-medium uppercase text-neutral-200 transition-colors hover:text-indigo-300"
        ...
        >
            ...
            <motion.span
                ...
                // className="duration-300 absolute inset-0 z-0 scale-125 bg-gradient-to-t from-indigo-400/0 from-40% via-green-primary to-indigo-400/0 to-60% opacity-0 transition-opacity group-hover:opacity-100"
