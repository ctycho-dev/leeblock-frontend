...
const CheckoutItem: FC<ICheckoutItem> = ({ item }) => {
    ...
    return (
        <>
            <div className="sm-mobile:bg-white rounded-3xl sm-mobile:py-2 sm-mobile:pr-4 mb-1 flex justify-between items-center">
                <div className="flex justify-between items-center">
                    <div className="relative">
                        <img src={item.sku.image} alt={item.sku.name} className="w-20 -ml-2 sm-mobile:ml-0" />
